 ...
 * @author manel
 */
@WebServlet(name = "elimpal", urlPatterns = {"/elimpal"})
public class elimpal extends HttpServlet {
...
private UserTransaction utx;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet elimpal</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<form metohd='pos' Action='eliminar_palabra.jsp'>");
