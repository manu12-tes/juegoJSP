 ...
 * @author manel
 */
@WebServlet(name = "eliminaPalabra", urlPatterns = {"/eliminaPalabra"})
public class eliminaPalabra extends HttpServlet {
 @PersistenceUnit
...
private UserTransaction utx;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet eliminaPalabra</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet eliminaPalabra at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
          ...
          EntityManager em = emf.createEntityManager();
           TypedQuery<Palabras> consultaAlumnos= em.createNamedQuery("Palabras.findByPalabra",Palabras.class);
            consultaAlumnos.setParameter("palabra", categori);
           ...
           controlPalabra.destroy(tp.getIdpalabra());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
     ...
     try {
         ...
         Logger.getLogger(eliminaPalabra.class.getName()).log(Level.SEVERE, null, ex);
     }
    }
